...
export function StatusLine({ channel, selectionActive = false, helpOpen = false, }) {
    ...
    if (channel.forceSmart) {
        contextParts.push(_jsx(Text, { color: "warning", bold: true, children: "ForceSmart" }, "enhancement"));
    }
    else if (channel.smart) {
        contextParts.push(_jsx(Text, { color: "suggestion", bold: true, children: "Smart" }, "enhancement"));
    }
