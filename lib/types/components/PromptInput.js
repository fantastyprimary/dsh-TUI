...
const ENHANCEMENT_ARROW_FRAMES = ['❯', '›', '»', '❯'];
const ENHANCEMENT_ARROW_INTERVAL_MS = 90;
function enhancementIndicator(channel) {
...
export function PromptInput({ channel, helpOpen, onToggleHelp, onRunCommand, selectionActive, fillText, onFillConsumed, onRewindRequest, controllerRef, }) {
    ...
    const previousEnhancement = React.useRef(undefined);
    const [enhancementFrame, setEnhancementFrame] = React.useState(ENHANCEMENT_ARROW_FRAMES.length - 1);
    React.useEffect(() => {
