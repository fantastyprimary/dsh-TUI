...
const dict = {
  ...
  'preset-liangshen-enhancement-conflict': { zh: '梁神模式是独立 preset，不能与 Smart 或 Smart-Pro 叠加；请先关闭当前增强', en: 'Liangshen is a standalone preset and cannot be stacked with Smart or Smart-Pro; disable the active enhancement first' },
  ...
  'force-smart-agent-running': { zh: 'Agent 运行中，无法切换 Smart-Pro', en: 'Agent is running; Smart-Pro cannot be switched' },
  'force-smart-unavailable': { zh: 'Smart-Pro 切换不可用——会话 fork 服务未挂载', en: 'Smart-Pro switch unavailable — session fork services are not loaded' },
  'force-smart-switch-failed': { zh: 'Smart-Pro 切换失败 · {{err}}', en: 'Smart-Pro switch failed · {{err}}' },
  'force-smart-already': { zh: 'Smart-Pro 已经是 {{state}}', en: 'Smart-Pro is already {{state}}' },
  'force-smart-switched': { zh: 'Smart-Pro 已切换为 {{state}}（对话已保留并保存为默认）', en: 'Smart-Pro switched {{state}} (conversation preserved and saved as default)' },
  'force-smart-switched-pref-failed': { zh: 'Smart-Pro 已切换为 {{state}}，但状态偏好未完整保存', en: 'Smart-Pro switched {{state}}, but its state preference was not fully saved' },
  'force-smart-current': { zh: 'Smart-Pro 增强  {{state}} · 仅支持 DeepSeek V4 模型', en: 'Smart-Pro enhancement  {{state}} · DeepSeek V4 models only' },
  'force-smart-model-required': { zh: 'Smart-Pro 仅支持 DeepSeek V4 模型（V4 Flash / V4 Pro）；当前模型 {{model}}。请先用 /model 切换', en: 'Smart-Pro supports only DeepSeek V4 models (V4 Flash / V4 Pro); the current model is {{model}}. Switch with /model first' },
  'force-smart-liangshen-conflict': { zh: '梁神模式有独立的首轮晋升逻辑，不能叠加 Smart-Pro；请先切换 preset', en: 'Liangshen has its own bootstrap promotion flow and cannot be stacked with Smart-Pro; switch presets first' },
  'force-smart-disabled-by-model': { zh: '模型已切换为 {{model}}，Smart-Pro 与该模型不兼容，已自动关闭', en: 'Model switched to {{model}}; Smart-Pro is not tuned for it and was switched off automatically' },
  'force-smart-usage': { zh: '用法：/smart-pro [on|off|status]', en: 'Usage: /smart-pro [on|off|status]' },
  ...
  'cmd-desc-smart-pro': { zh: 'DeepSeek V4 锚定增强，优先适配 V4 Pro', en: 'DeepSeek V4 anchoring tuned primarily for V4 Pro' },
